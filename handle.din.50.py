...
flags.DEFINE_string("logfile",'logs.din.50.out',"log file to save")
flags.DEFINE_string("csvfile","test_metric_day.din.50.csv",'csv file to save test metric')
...
RST_PATH = os.path.join(PATH, "result_din_50")

BASE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "save_din_50")
