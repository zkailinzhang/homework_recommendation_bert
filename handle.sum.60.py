...
flags.DEFINE_string("logfile",'logs.sum.60.out',"log file to save")
flags.DEFINE_string("csvfile","test_metric_day.sum.60.csv",'csv file to save test metric')
...
BASE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "save_sum_60")
