...
flags.DEFINE_string("logfile",'logs.gru.46.out',"log file to save")
flags.DEFINE_string("csvfile","test_metric_day.gru.46.csv",'csv file to save test metric')
...
RST_PATH = os.path.join(PATH, "result_gru_46")
BASE_PATH = os.path.join(PATH, "save_gru_46")
