...
flags.DEFINE_string("logfile",'logs.dien.47.out',"log file to save")
flags.DEFINE_string("csvfile","test_metric_day.dien.47.csv",'csv file to save test metric')
...
RST_PATH = os.path.join(PATH, "result_dien_47")

BASE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "save_dien_47")
...
def prepare_data(data):
    ...
    resp["history_len_ph"]= np.ones(shape=(cnt_samples)).astype("float32")
