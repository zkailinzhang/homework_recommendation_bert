...
flags.DEFINE_string("logfile",'logs.sum.47.out',"log file to save")
flags.DEFINE_string("csvfile","test_metric_day.sum.47.csv",'csv file to save test metric')
...
RST_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "result_sum_47")
BASE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "save_sum_47")
