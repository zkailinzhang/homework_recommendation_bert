...
flags.DEFINE_string("logfile",'logs.bgru.60.out',"log file to save")
flags.DEFINE_string("csvfile","test_metric_day.bgru.60.csv",'csv file to save test metric')
...
RST_PATH = os.path.join(PATH, "result_bgru_60")
BASE_PATH = os.path.join(PATH, "save_bgru_60")
