...
flags.DEFINE_string("logfile",'logs.bgru.47.out',"log file to save")
flags.DEFINE_string("csvfile","test_metric_day.bgru.47.csv",'csv file to save test metric')
...
RST_PATH = os.path.join(PATH, "result_bgru_47")
BASE_PATH = os.path.join(PATH, "save_bgru_47")
